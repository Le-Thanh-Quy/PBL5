...
import time
from recognition import trainingFace
from lcd_print import lcd_print, lcd_clear

def start_recognize_and_training(SERIAL):
    path_default = "/home/qthv/Desktop/PBL5/recognition/DuLieuKhuonMat/"
    ten = SERIAL
    cap = cv2.VideoCapture(0)
    soluong = 25
    sl = 0
    while sl < soluong:
        lcd_print("Training..." + str(int(sl/soluong * 100)) + "%")
        ret, frame = cap.read()
